...
print "<div class='ols-controls'><a class='ols-control primary' href='service.cgi?action=start'>Start</a><a class='ols-control danger' href='service.cgi?action=stop'>Stop</a><a class='ols-control' href='service.cgi?action=restart'>Restart</a><a class='ols-control' href='listeners.cgi'>Listeners</a><a class='ols-control' style='margin-left:auto' href='domains.cgi'>Add / Remove Domains</a></div></div>";
