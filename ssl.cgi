...
.ols-ssl-hero-deps{min-width:230px;padding-left:28px;border-left:1px solid var(--border-color,rgba(128,128,128,.18))}
.ols-ssl-hero-deps-title{font-size:12px;font-weight:700;margin-bottom:8px}
.ols-ssl-hero-deps-status{display:flex;align-items:center;gap:8px;font-size:12px;margin-bottom:10px}
...
print "<div class='ols-ssl-hero'><div class='ols-ssl-hero-main'><span class='ols-kicker'>SSL Certificate Manager</span><h1>".&html_escape($vh)."</h1><p class='ols-muted'>Manage the SSL certificate for this virtual host.</p></div><div class='ols-ssl-hero-deps'><div class='ols-ssl-hero-deps-title'>SSL Dependencies</div><div class='ols-ssl-hero-deps-status".($certbot_installed?'':' off')."'><span class='ols-deps-dot'></span><span>".($certbot_installed?'Certbot is installed':'Certbot is not installed')."</span></div><a class='ols-btn' href='ssl-dependencies.cgi?vh=".&urlize($vh)."'>Manage Dependencies →</a></div></div>";
